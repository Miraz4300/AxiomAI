        ...
        >
          <template v-if="!dataSources.length">
            <div class="flex items-center justify-center mt-4 text-center text-neutral-300">
              ...
              >
                <h1 class="text-4xl font-semibold mt-[18vh] ml-auto mr-auto mb-16">
                  AxiomAI-preview
                </h1>
                <div class="flex items-start text-center gap-3.5">
                  <div class="flex flex-col gap-3.5 flex-1">
                    <svg
                      ...
                      stroke-linejoin="round" class="w-6 h-6 m-auto" height="1em" width="1em"
                    ...
                    <ul class="flex flex-col gap-3.5">
                      <li
                        class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md after:content-['&quot;'] before:content-['&quot;']"
                      >
